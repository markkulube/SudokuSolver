...
int main() {
    ...
    /*
    int row1v[9] = {1, 2, 3,   4, 5, 6,   7, 8, 9};
    int row2v[9] = {7, 8, 9,   1, 2, 3,   4, 5, 6};
    int row3v[9] = {4, 5, 6,   7, 8, 9,   1, 2, 3};

    int row4v[9] = {3, 1, 2,   8, 4, 5,   9, 6, 7};
    int row5v[9] = {6, 9, 7,   3, 1, 2,   8, 4, 5};
    int row6v[9] = {8, 4, 5,   6, 9, 7,   3, 1, 2};

    int row7v[9] = {2, 3, 1,   5, 7, 4,   6, 9, 8};
    int row8v[9] = {9, 6, 8,   2, 3, 1,   5, 7, 4};
    int row9v[9] = {5, 7, 4,   9, 6, 8,   2, 3, 1};
    */
